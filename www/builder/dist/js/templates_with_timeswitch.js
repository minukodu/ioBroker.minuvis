    ...
    <div class="card widget timeswitch" data-widgettype="timeswitch">
        ...
        <div class="card-body">
            ...
            <form>
                <div class="input-group input-group-sm mb-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text alert-info">value for on</span>
                    </div>
                    <input type="text" class="form-control  form-control-sm onValue" value="true">
                </div>
                <div class="input-group input-group-sm mb-2">
                    <div class="input-group-prepend">
                        <span class="input-group-text alert-info">value for off</span>
                    </div>
                    <input type="text" class="form-control  form-control-sm offValue" value="false">
                </div>
            </form>    
            <hr/>
            <!-- values -->
